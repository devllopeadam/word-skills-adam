    ...
    switch (selectedFilter) {
      case "max-wow":
        return [...anecdotes].sort(
          (a, b) => (b.rating?.wow || 0) - (a.rating?.wow || 0)
        );
      case "wow-or":
      ...
      case "technique":
        return [...anecdotes].sort(
          (a, b) => (b.rating?.technique || 0) - (a.rating?.technique || 0)
        );
      default:
        return anecdotes;
    }
          ...
          <div
            ...
            <div
              ...
              <p
                ...
                Lorem ipsum dolor sit amet consectetur, in ut ut libero amet
                hendrerit pharetra mauris rhoncus...
              </p>
              <div
                style={{
                  display: "flex",
            ...
            <div
              ...
              <div
                ...
                <div
                  style={{ display: "flex", alignItems: "center", gap: "4px" }}>
                  <span style={{ color: "#111", fontSize: "12px" }}>
                    👎 167
                  </span>
                </div>
                <div
